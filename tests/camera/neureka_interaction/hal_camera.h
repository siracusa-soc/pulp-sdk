...
#define CAMERA_CLUS_CTRL_ADDR_BASE 0x00200000
...
#define CAMERA_CLUS_CTRL_HWPE_OFFS              0x18
#define CAMERA_CLUS_CTRL_HWPE_CG_EN_MASK        0x800
#define CAMERA_CLUS_CTRL_HWPE_HCI_PRIO_MASK     0x100
#define CAMERA_CLUS_CTRL_HWPE_HCI_MAXSTALL_MASK 0xff
...
#define CAMERA_CG_ENABLE()  *(volatile int*) (CAMERA_CLUS_CTRL_ADDR_BASE + CAMERA_CLUS_CTRL_HWPE_OFFS) |=  CAMERA_CLUS_CTRL_HWPE_CG_EN_MASK
#define CAMERA_CG_DISABLE() *(volatile int*) (CAMERA_CLUS_CTRL_ADDR_BASE + CAMERA_CLUS_CTRL_HWPE_OFFS) &= ~CAMERA_CLUS_CTRL_HWPE_CG_EN_MASK

#define CAMERA_SETPRIORITY_CORE() *(volatile int*) (CAMERA_CLUS_CTRL_ADDR_BASE + CAMERA_CLUS_CTRL_HWPE_OFFS) &= ~CAMERA_CLUS_CTRL_HWPE_HCI_PRIO_MASK
#define CAMERA_SETPRIORITY_CAMERA() *(volatile int*) (CAMERA_CLUS_CTRL_ADDR_BASE + CAMERA_CLUS_CTRL_HWPE_OFFS) |=  CAMERA_CLUS_CTRL_HWPE_HCI_PRIO_MASK

#define CAMERA_RESET_MAXSTALL()  *(volatile int*) (CAMERA_CLUS_CTRL_ADDR_BASE + CAMERA_CLUS_CTRL_HWPE_OFFS) &= ~CAMERA_CLUS_CTRL_HWPE_HCI_MAXSTALL_MASK
#define CAMERA_SET_MAXSTALL(val) *(volatile int*) (CAMERA_CLUS_CTRL_ADDR_BASE + CAMERA_CLUS_CTRL_HWPE_OFFS) |=  (val & CAMERA_CLUS_CTRL_HWPE_HCI_MAXSTALL_MASK)
    ...
    for(int j=0; j<n_rows; j++) {
      for(int k=0; k<n_col_words; k++){
          ...
          if(errors==1) printf("  golden     <- actual     @ address    @ index\n");
            printf(" CAMERA Error 0x%08x <- 0x%08x @ 0x%08x @ 0x%08x\n", golden_word, actual_word, (actual_addr-actual_y), (golden_addr-golden_y));
          }
      }
    }
  }
